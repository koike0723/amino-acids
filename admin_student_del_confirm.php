...
<body>
    ...
    <main>
        ...
        <div class="student-detail-dl-area">
            ...
            <div class="student-detail-controle-area d-flex align-items-center" style="gap: 12px;">
                <a href="./php_do/student_del_do.php?id=<?= h($student['student_id']); ?>"
